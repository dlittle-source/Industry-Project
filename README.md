...
2. **Terraform Implementation**:
   ...
   - Set up and configured the SonarQube server following the official documentation, integrated the SonarQube plugin with Jenkins, and set up secure authentication by generating a token.
